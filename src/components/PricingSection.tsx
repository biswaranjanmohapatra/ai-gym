...
const plans = [
  {
    ...
    iconBg: 'bg-secondary/20 border-border/40',
    features: ['Access to trainer profiles', 'Basic workout tracking', 'Community access', '1 trainer booking/month'],
    popular: false,
    amount: 199,
    buttonStyle: 'bg-secondary/80 text-foreground hover:bg-secondary border border-border/40 hover:text-foreground',
    buttonLabel: 'Subscribe to Basic',
    cardStyle: 'bg-card/60 border-border/30 hover:border-border/50',
  },
  {
    name: 'Pro',
    price: '₹499',
    ...
    iconBg: 'bg-primary/5 border-primary/40',
    features: ['Everything in Basic', 'Unlimited trainer bookings', 'Advanced workout plans', 'Diet & nutrition tracking', 'Priority support'],
    popular: true,
    amount: 499,
    ...
    cardStyle: 'bg-card/80 border-primary/40 shadow-[0_0_30px_hsl(142_72%_50%/0.1)] hover:border-primary/60',
  },
  {
    name: 'Elite',
    price: '₹999',
    ...
    iconBg: 'bg-yellow-400/5 border-yellow-400/40',
    features: ['Everything in Pro', 'Priority trainer access', 'Exclusive training programs', 'Monthly 1-on-1 consultation', 'Dedicated support', 'Custom meal plans'],
    popular: false,
    amount: 999,
    buttonStyle: 'bg-yellow-500 text-black hover:bg-yellow-400 shadow-[0_0_20px_hsl(45_100%_50%/0.3)] font-bold',
    buttonLabel: 'Subscribe to Elite',
    cardStyle: 'bg-card/60 border-yellow-400/20 hover:border-yellow-400/40',
  },
];
